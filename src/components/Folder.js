...
class Folder extends Component {
  ...
  openLink = () => {
    ...
    shell.showItemInFolder(`${argv.loc}/${parent}/${folderName}`);
  }
  ...
  preview = () => {
    const { folderName, port, parent } = this.props;
    ...
    if(this.state.serving){
      ...
      serving = true;
      color = '#E58E73';
      shell.openExternal(`http://localhost:5555/${parent}/${folderName}/index.html`);
    }
